...
<link rel="stylesheet" href="./resources/css/slide222.css" type="text/css">
...
<script>
    window.addEventListener('DOMContentLoaded', function(){
        ...
        document.querySelector('#roller2').style.left = document.querySelector('.roller a').offsetWidth + 'px';
