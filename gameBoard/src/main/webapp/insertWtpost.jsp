	...
	<div class="form-container">
		<form action="insertWtpost.do" method="post"
			...
			<div class="form-group">
				<label for="title">제목</label> <input type="text" id="wtTitle"
					name="wtTitle" maxlength="16" oninput="updateCharCount()">
				<span class="char-count" id="charCount">0/16</span>
			</div>
			<div class="form-group">
				<label for="content">내용</label>
				<div id="wtContent" contenteditable="true" class="content-editable"></div>
