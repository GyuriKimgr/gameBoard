        ...
        <div class="news1">
            <a name="news_1" class="gamenews"
                ...
                <div class="gamenews_1">
                    <img src="https://pbs.twimg.com/media/GPdbQgCbQAAwBes?format=jpg&name=medium" class="news_img">
                </div> 
            ...
            <div class="group_tit1">
                <a name="news_1" class="gamenews"
                    href="https://www.thisisgame.com/webzine/news/nboard/4/?utm_source=naver?utm_source?utm_source?utm_source?utm_source&utm_medium=outlink&utm_campaign=thisisgame&utm_content=85668&referer=coinsosik&category=1&n=189696"
                    event-order="1" event-description="리틀 나이트메어 3' 출시 연기, 2024년 내에는 만나기 어렵다"
                    event="click_news" news type="게임 연기"
                ...
                <a name="new_1" class="gamenews"
                    ...
                    vent="click_news" news type="대회소식" news title="쿠키런">
    ...
    <li>
        ...
        <div class="news1">
            <a name="news_1" class="gamenews"
                ...
                event="click_news" news type="대회소식"
                news_title="PGS 4 그룹 스테이지 하이라이트">
                
                <div class="gamenews_1">
                    <img src="https://t1.kakaocdn.net/gamepub/pub-img/pubg/news_banner/news_banner_1717741626073_39.png" class="news_img">
                </div> 
            ...
            <div class="group_tit1">
                <a name="news_1" class="gamenews"
                    ...
                    event="click_news" news type="대회소식"
                    news title="펍지 글로벌 시리즈 3(PGS 3)를 소개합니다!"> 
                    <strong class="tit1">펍지 글로벌 시리즈 3(PGS 3)를 소개합니다!</strong>
                </a>
                <a name="news_1" class="gamenews"
                    href="#"
                    event-order="2" event-description="2024 PLS: Cup 안내"
                    event="click_news" news type="대회소식" news title="2024 PLS: Cup 안내">
