	...
	<div class="form-container">
		<form action="insertMod.do" method="post"
			...
			<div class="form-group">
				<label for="title">제목</label> <input type="text" id="mTitle"
					name="mTitle" maxlength="16" oninput="updateCharCount()"> <span
					class="char-count" id="charCount">0/16</span>
			</div>
			<div class="form-group">
				<label for="content">내용</label>
				<div id="mContent" contenteditable="true" class="content-editable"></div>
...
<script>
	...
	function validateForm() {
		...
		var mContent = document.getElementById("mContent").innerHTML.trim();
		...
		document.getElementById("mContentHidden").value = mContent;
