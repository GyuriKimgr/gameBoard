					...
					<a name="a_new_notice" class="link_thumb"
						...
						<div class="wrap_thumb">
							<img
								...
								class="thumb_g" alt="">
						</div> <strong class="card_tit"> PUBG x 뉴진스 캐릭터 콜라보 아이템 보상/환급
							안내 </strong> <span class="desc_thumb">이번 공지를 통해서 인게임 변경 사항과 그에 따른
							보상 및 환급 대응안에 대해 안내 드리고자 합니다. 기존 불운 방지 문구 이슈의 G-COIN 보상과 의상 착용 제한
							이슈의 G-COIN 보상이 각각 책정되었으나, 플레이어 분들의 편의를 위해 동일 시스템을 통해 한번에 지급됩니다.
							아래 상세 내용을 확인하여 희망하시는 대응안을 신청해 주시길 바라며, 다시 한번 즐거움을 드려야 할 콜라보레이션에
					...
					<a name="a_new_update" class="link_thumb"
						...
						<div class="wrap_thumb">
							<img
								...
								class="thumb_g" alt="">
						</div> <strong class="card_tit"> PUBG x 뉴진스 콜라보 및 경쟁전 개편 업데이트
							안내 </strong> <span class="desc_thumb">배틀그라운드와 뉴진스의 콜라보레이션과 경쟁전 개편
					...
					<a name="a_new_gm" class="link_thumb"
						...
						<div class="wrap_thumb">
							<img
								...
								class="thumb_g" alt="">
						</div> <strong class="card_tit"> 6월 추가 특별 보급 </strong> <span
						class="desc_thumb">최근 연달아 게임 이용에 불편을 겪게 하신 것에 대해 고개 숙여
							사과드립니다. ​여러분이 느끼셨을 불편함을 그 어떤 것으로도 보상해 드리기 어렵겠지만, 죄송한 마음을 담아 추가
							이벤트를 준비해 보았습니다. </span>
					</a>
					<div class="group_tit">
						...
						<a name="a_new_gm" class="link_thumb"
							href="https://bbs.pubg.game.daum.net/gaia/do/pubg/gm/read?articleId=716&amp;bbsId=PN002&amp;pageIndex=1"
