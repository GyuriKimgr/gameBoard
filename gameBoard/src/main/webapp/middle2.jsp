...
<div class="box">
    <ul class="middle2">
        <li><a href="./walkThrough.do" class="link_card"> 
        ...
        <div class="news2">
            ...
            <c:if test="${not empty recentWtPosts}">
                <c:forEach var="post" items="${recentWtPosts}">
                    <div class="contents">
                        <strong class="tit3">
                            <a href="./getWtpost.do?wtID=${post.wtID}">
                                ${post.wtTitle}
                            </a>
                        </strong>
                        <div>
        ...
        <li><a href="./Mod.do" class="link_card"> 
        ...
        <li><a href="./suggest.do" class="link_card"> 
        ...
        <div class="news2">
            ...
            <c:if test="${not empty recentSgPosts}">
                <c:forEach var="post" items="${recentSgPosts}">
                    <div class="contents">
                        <strong class="tit3">
                            <a href="./getSgpost.do?sgID=${post.sgID}">
                                ${post.sgTitle}
                            </a>
                        </strong>
                        <div>
